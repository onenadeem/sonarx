...
function Dot({ index }) {
  ...
  useEffect(() => {
    translateY.value = withDelay(
      ...
      withRepeat(
        withSequence(
          withTiming(BOUNCE_OFFSET, { duration: BOUNCE_DURATION }),
          withTiming(BOUNCE_START, { duration: BOUNCE_DURATION }),
        ),
        -1,
        false,
      ),
  ...
  return (
    <Animated.View
      style={[styles.dot, buildDotStyle(colors.textSecondary), animStyle]}
    />
  );
}
