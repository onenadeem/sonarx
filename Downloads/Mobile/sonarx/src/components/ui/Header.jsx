...
export default function Header({
  ...
  const titlePadding =
    titleAlign === "start" && titlePaddingHorizontal > 0
  ...
  const hasCenterAccessory =
    centerAccessory !== undefined && centerAccessory !== null;
  const renderedLeft = leftAccessory ? (
    leftAccessory
  ) : leftIcon ? (
    <AnimatedPressable
      onPress={onLeftPress}
    ...
    >
      <View
        style={[
          styles.leftSection,
          centerPillCentered
            ? [styles.centerPillSideSection, styles.centerPillLeftSection]
            : null,
        ]}
      >
      ...
      >
        {hasCenterAccessory ? (
          ...
          <View style={[styles.titleBlock, titlePadding]}>
            <Text
              style={[
                styles.title,
                {
                  ...
                  textAlign:
                    computedTitleAlign === "flex-start" ? "left" : "center",
                },
              ]}
              numberOfLines={1}
            >
      ...
      <View
        style={[
          styles.rightSection,
          centerPillCentered
            ? [styles.centerPillSideSection, styles.centerPillRightSection]
            : null,
        ]}
      >
